...
},{"./css/styles.css":"1CY4s","./fetchCountries":"fTQqv","notiflix/build/notiflix-notify-aio":"eXQLZ","lodash.debounce":"3JP5n"}],"1CY4s":[function() {},{}],"fTQqv":[function(require,module,exports) {
...
const fetchCountries = (countryName)=>fetch(`${BASE_URL}${countryName}?${searchParams}`).then((response)=>{
